...
public enum Planet {
    PLUTO   ("Pluton",  Type.HIGH_CARD,        10, 1),
    MERCURY ("Mercure", Type.PAIR,             15, 1),
    URANUS  ("Uranus",  Type.TWO_PAIR,         20, 1),
    VENUS   ("Vénus",   Type.THREE_OF_A_KIND,  20, 2),
    SATURN  ("Saturne", Type.STRAIGHT,         30, 3),
    JUPITER ("Jupiter", Type.FLUSH,            15, 2),
    EARTH   ("Terre",   Type.FULL_HOUSE,       25, 2),
